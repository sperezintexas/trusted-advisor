        ...
        <div className="w-full max-w-sm rounded-lg border border-[var(--docs-border)] bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-[var(--docs-border)] bg-white px-4 py-3 text-sm font-medium text-[var(--docs-text)] hover:bg-[var(--docs-code-bg)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--docs-accent)] focus-visible:ring-offset-2"
            >
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#24292f] px-4 py-3 text-sm font-medium text-white hover:bg-[#32383f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--docs-accent)] focus-visible:ring-offset-2"
            >
